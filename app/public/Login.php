...
<body>
    <div class="header">
        <a href="index.php"><img id="logo" src="images/homeicon.PNG"></a>
    </div>
    <div class="mainbody">
        <div class="card">
            ...
            <div class="cardinside">
                ...
                <span id="formatmessage" style="color:red; display:none;">Please input value in right format.(Case sensitive)</span> <!--to make it case sensitive-->
                <p>Password <br /> <input type="password" id="password" name="password"><br /></p>
                <div class="buttons">
                    <input type="submit" id="submit" value="Log in" name="submit">&nbsp;&nbsp;
                    <input type="button" id="forgetpassword" value="Forget Password?"></a>
                </div>
                <hr style="width: 60%;" />
