    ...
    <div class="firstrow">
        ...
        <div class="mainbody">
            ...
            <div class=" card">
                ...
                <div class="cardinside">
                    <p>The MentorshipLadder Newsletter<br />
                        <label><input type="checkbox" id="check1">I would like to recieve the MentorshipLadder newsletter which
                            includes: <br />
                            <ul>
                                <li>new mentor</li>
                                <li>promotions</li>
                    ...
                    <p>The MentorshipLadder and its partners<br />
                        <label><input type="checkbox" id="check2">I would like to recieve occational offers, surveys and
                            promotions presented by the MentorshipLadder which may be
