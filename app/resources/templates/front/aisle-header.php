...
<head>
  ...
  <meta name="description" content="Aisle Page" />

  <!-- Bootstrap CSS -->
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/css/bootstrap.min.css"
    integrity="sha384-B0vP5xmATw1+K9KRQjQERJvTumQW0nPEzvF6L/Z6nronJ3oUOFUFpCjEUQouq2+l" crossorigin="anonymous" />

  <!-- Include Google Icons/Fonts -->
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet" />
  <link rel="preconnect" href="https://fonts.googleapis.com" />
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
  <link href="https://fonts.googleapis.com/css2?family=Lato&family=Open+Sans&display=swap" rel="stylesheet" />

  <title>The MentorshipLadder | Features</title>
...
<body  class="d-flex flex-column min-vh-100">
  ...
  <header class="container-fluid">
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
      <a class="navbar-brand" href="../index.php"><img src="../images/mentorship logo.PNG" alt="MentorshipLadder Logo" /></a>
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarAisles">
              <a class="dropdown-item" href="MeetMentors.php">Find Mentors</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="BecomeMentors.php">Become a Mentor</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="BestMentors.php">Best Mentor</a>
